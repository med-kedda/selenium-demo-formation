...
public class SeleniumFormation {
	...
	public static void main(String[] args) throws Exception {
		...
		driver.get("https://formation.eserviceslab.com");
	...
	private static void addDemand() throws Exception {
		...
		WebElement matricule = findElementByXpath("//*[@id=\"matricule\"]");
		WebElement selectMinistry = findElementByXpath("//*[@id=\"ministre\"]");
		WebElement selectFormation = findElementByXpath("//*[@id=\"formation\"]");
		WebElement LettreInput = findElementByXpath("//*[@id=\"dmd\"]");

		Thread.sleep(3000);
		if (selectMinistry.isDisplayed() && selectFormation.isDisplayed() && LettreInput.isDisplayed()) {

			Select selectedMinisry = new Select(selectMinistry);
			selectedMinisry.selectByIndex(1);
			
			Select selectedFromation = new Select(selectFormation);
			selectedFromation.selectByIndex(1);
